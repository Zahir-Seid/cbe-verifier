...
func TestClassifyReference(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "bare legacy reference", input: "FT25062PP5ZB", want: RefLegacy, wantID: "FT25062PP5ZB"},
		{name: "bare legacy lowercased", input: "ft25062pp5zb", want: RefLegacy, wantID: "FT25062PP5ZB"},
		{name: "legacy with surrounding spaces", input: "  FT25062PP5ZB\n", want: RefLegacy, wantID: "FT25062PP5ZB"},
		{
		...
		{name: "plain token", input: "AbCdEf123456789", want: RefNewToken, wantTok: "AbCdEf123456789"},
		...
		{name: "mbreciept URL", input: "https://mbreciept.cbe.com.et/AbCdEf123456789", want: RefNewToken, wantTok: "AbCdEf123456789"},
		{name: "mbreciept URL trailing slash", input: "https://mbreciept.cbe.com.et/AbCdEf123456789/", want: RefNewToken, wantTok: "AbCdEf123456789"},
